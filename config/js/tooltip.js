...
tooltips['users'] .en[17] = "<B>Hints:</B> If checked the phone being called will be sent a \"hint\" to light up status lamps on SIP phones.";
	...
	tooltips['users'] .en[100] = "<B>Record :</B> Record the call communication for the user." ;
	tooltips['users'] .en[100] = "<B>Auto Provisioning :</B> Generate a configuration file to ftp boot directory.Please see the documentation of Autoprovisioning." ;
...
// Tooltips for IAX_General (iax_general)
	...
	tooltips['record'].en[90] = "To help you create a customized IVR system for your business, voice prompts are available in English, French and Spanish, and are provided by ESI. Please contact ESI support team.";
